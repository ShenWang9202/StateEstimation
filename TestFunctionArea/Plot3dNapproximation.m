...
hold('on');
surf(Q23,Q34,Z,'FaceColor','r','FaceAlpha',0.8,'EdgeColor','none','DisplayName','Head loss surface')
% mass conservation
hold('on');
Q1_B = d3 + Q34;
surf(Q1_B,Q34,Z,'FaceColor','b','FaceAlpha',0.8,'EdgeColor','none','DisplayName','Demand surface')
%
%
% hold on
...
surf(Q23,Q34,Z,'FaceColor','k','FaceAlpha',0.4,'EdgeColor','none','DisplayName','Measured head different')
...
view(subplot1,[-152.3 6.80000000000008]);
...
hold(subplot2,'on');
dot=[q23 q34 z_f];
plot3(dot(:,1),dot(:,2),dot(:,3),'Marker','*','MarkerSize',15,'Color',[0 1 0],'LineWidth',5);
view(subplot2,[-152.3 6.80000000000008]);
